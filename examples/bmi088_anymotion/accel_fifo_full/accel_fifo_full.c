...
static void init_bmi08(struct bmi08_dev *bmi08dev)
{
    ...
    {
        printf("BMI088 initialization success!\n");
    ...
    {
        printf("BMI088 initialization failure!\n");
...
static void configure_bmi08_fifo_full_interrupt(struct bmi08_dev *bmi08dev)
{
    ...
    rslt = bmi088_anymotion_set_int_config(&int_config, BMI088_ANYMOTION_ACCEL_INT_FIFO_FULL, bmi08dev);
